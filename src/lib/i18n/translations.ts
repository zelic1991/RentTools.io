...
/**
 * Noun form for a count in Czech and Slovak: 1, then 2-4, then
 * everything else. Unlike Croatian and Polish there is no ends-in-digit
 * rule - 21 osob takes the same form as 5 osob, not the singular.
 */
