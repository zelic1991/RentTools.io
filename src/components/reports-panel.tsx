...
const COPY: CopyMap<CopyShape> = {
  ...
  hr: {
    ...
    pastWindow: (months) =>
      `zadnjih ${months} ${months === 1 ? "mjesec" : months < 5 ? "mjeseca" : "mjeseci"}`,
    noProperties: "Još nema nekretnina za izvještaj.",
    pastOccupancy: "Prošla popunjenost",
    upcomingNights: "Nadolazeća noćenja",
    upcomingNightsSubtitle: (months) => `sljedećih ${months} mj.`,
    bookings: "Rezervacije",
    avgNights: (n) => `prosj. ${n} noćenja`,
    allTime: "ukupno",
    cleaningsAhead: "Nadolazeća čišćenja",
    cleaningsAheadSubtitle: "jedno nakon svake odjave",
    topSource: "Glavni izvor:",
    chartHeader: (max) => `Zauzeta noćenja po mjesecu (najviše ${max})`,
    yAxisUnit: "d",
    tooltipUnit: "noćenja",
    now: "sada",
    past: "prošlo",
    ...
    loading: "Učitavanje…",
    byProperty: "Po nekretnini",
    byPropertyHint: "Kliknite nekretninu za njezin izvještaj.",
    colProperty: "Nekretnina",
    colPastOcc: "Prošla pop.",
    colUpcoming: "Nadolazeće",
    colBookings: "Rezervacije",
    colCleanings: "Čišćenja",
    colTopSource: "Glavni izvor",
    allPropertiesLabel: (count) => `Sve nekretnine (${count})`,
    period: "Razdoblje",
    allPeriod: "Sve",
    monthsLabel: (n) => `${n}M`,
    periodHelp: "Prošlo razdoblje + sljedećih 6 mjeseci. „Sve” seže do vašeg najranijeg boravka.",
    exportTitle: "Izvoz rezervacija",
    exportingProperty: (name) => `Izvoz: ${name}.`,
    exportingAll: (count) => `Sve nekretnine (${count}).`,
    fromLabel: "Od",
    toLabel: "Do",
    downloadCsv: "Preuzmi CSV",
    exportHelp: "Ostavite datume prazne za izvoz svega. UTF-8 BOM za Excel.",
    dataSources: "Izvori podataka",
    dataSourcesHelp:
      "Brojke spajaju vaše rezervacije i iCal događaje. Preuzeta rezervacija zamjenjuje svoj događaj s platforme; izravna produženja ostaju odvojena. Prošli boravci ostaju u bazi i nakon što ih platforme uklone iz svojih feedova.",
  },
};
