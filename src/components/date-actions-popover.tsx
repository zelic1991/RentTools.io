...
const COPY: CopyMap<CopyShape> = {
  en: {
    ...
    createReservationDesc: "Add a reservation starting on this date. Shift-click a later day to select the whole stay.",
  ...
  ru: {
    ...
    createReservationDesc: "Добавить бронь, начинающуюся в этот день. Shift+клик по другому дню выделит весь период.",
  ...
  de: {
    ...
    createReservationDesc: "Eine Buchung ab diesem Datum hinzufügen. Mit Shift-Klick auf einen späteren Tag den ganzen Aufenthalt wählen.",
  ...
  fr: {
    ...
    createReservationDesc: "Ajouter une réservation démarrant à cette date. Maj+clic sur un jour ultérieur pour sélectionner tout le séjour.",
  ...
  es: {
    ...
    createReservationDesc: "Añade una reserva que empiece en esta fecha. Mayús+clic en un día posterior para seleccionar toda la estancia.",
  ...
  hr: {
    dateLocale: "hr-HR",
    staysTurnover: (count) => `${count} ${count === 1 ? "boravak" : "boravka"} — smjena`,
    manualCleaning: "Ručno čišćenje",
    blockDate: "Blokiraj ovaj datum",
    blockDateDesc: "Zaustavlja nove rezervacije. Bez oznake čišćenja.",
    scheduleCleaning: "Zakaži čišćenje",
    scheduleCleaningDesc: "Blokira datum i označava ga kao termin čišćenja.",
    makeAvailable: "Otvori za rezervacije",
    makeAvailableDesc: "Zanemari pauzu i najmanji broj noćenja za ovaj datum.",
    unblockDate: "Odblokiraj ovaj datum",
    removeCleaning: "Ukloni čišćenje",
    resetOverride: "Vrati na zadano",
    resetOverrideDesc: "Vraća ovaj datum u automatski prepoznato stanje.",
    createReservation: "Nova rezervacija",
    createReservationDesc: "Dodaje rezervaciju koja počinje na ovaj datum. Shift-klik na kasniji dan označava cijeli boravak.",
    cancelCleaningOnBooked: "Otkaži čišćenje",
    cancelCleaningOnBookedDesc: "Oslobađa ovaj datum od čišćenja — zakažite ga drugi dan.",
    removeCleaningDescAuto: "Vrati na automatski prijedlog.",
    cancelCleaningOnAuto: "Otkaži čišćenje",
    cancelCleaningOnAutoDesc: "Oslobađa ovaj datum — čišćenje zakažite drugi dan.",
    blockAll: (count) => `Blokiraj sve (${count})`,
    scheduleAll: (count) => `Zakaži čišćenje (${count})`,
    openAll: (count) => `Otvori za rezervacije (${count})`,
    resetAll: (count) => `Vrati izmjene (${count})`,
    createBulk: (count) => `Nova rezervacija (${count} ${count === 1 ? "noćenje" : "noćenja"})`,
    createBulkDesc: (checkIn, checkOut) =>
    ...
    bufferRequiredNote:
      "Ova nekretnina drži pauzu za čišćenje prije svakog dolaska, pa boravak ne može završiti na dan prijave sljedećeg gosta. Odznačite taj dan ili postavite pauzu na 0 u postavkama sinkronizacije.",
    noActions: "Nema dostupnih radnji.",
    selectedDates: "Odabrani datumi",
    daysCount: (count) => (count === 1 ? "dan" : "dana"),
    bookedDisabled: (count) => `${count} rezervirano — skupne radnje onemogućene`,
    contiguousRange: "Povezani raspon",
    nonContiguous: "Nepovezano",
    close: "Zatvori",
    checkingOut: "odjava",
    checkingIn: "prijava",
    singleDayStay: "jednodnevni boravak",
    staying: "boravak",
    cleanLabel: "Čišćenje",
    cleaningScheduled: "Čišćenje zakazano",
    cleaningRequired: "Potrebno čišćenje",
    betweenStays: "između boravaka",
    ...
    nightsParenthetical: (count) => `(${count} ${count === 1 ? "noćenje" : "noćenja"})`,
    ...
    addNights: (nights, side) =>
      `Dodaj ${nights} ${nights === 1 ? "noćenje" : "noćenja"} ${side}`,
    cancel: "Odustani",
    saving: "Spremanje…",
    save: "Spremi",
    trimToDate: (date) => `Završi rezervaciju ${date}`,
    trimToDateDesc: "Skraćuje rezervaciju tako da je odabrani dan zadnji.",
    trimRemoveDate: (date) => `Ukloni ${date} iz rezervacije`,
    trimRemoveDateDesc: "Izbacuje ovaj zadnji dan iz rezervacije.",
  },
};
