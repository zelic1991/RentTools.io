...
const COPY: CopyMap<CopyShape> = {
  ...
  hr: {
    default: "Zadana",
    firstBackup: "1. zamjena",
    secondBackup: "2. zamjena",
    nthBackup: (rank) => `${rank}. zamjena`,
    failed: "Nije uspjelo",
    cleaners: "Čistačice",
    add: "+ Dodaj",
    emptyState: "Nitko nije dodijeljen. Dodajte zadanu osobu i po želji zamjene.",
    legacyLogin: "Stara prijava",
    moveUp: "Pomakni gore",
    moveDown: "Pomakni dolje",
    remove: "Ukloni",
    poolEmpty: "Sve osobe s vašeg popisa već su dodijeljene",
    pickFromPool: "Odaberite s popisa…",
    createNew: "+ Dodaj novu",
    cancel: "Odustani",
    addBtn: "Dodaj",
    namePlaceholder: "Ime",
    phonePlaceholder: "Telefon (nije obavezno)",
    back: "Natrag",
    createAndAdd: "Stvori i dodaj",
  },
};
